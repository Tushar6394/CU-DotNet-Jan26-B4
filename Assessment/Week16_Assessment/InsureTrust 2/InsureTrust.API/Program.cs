...
using InsureTrust.API.Application.Mapping;
using InsureTrust.API.Application.Services;
using InsureTrust.API.Application.Validation;
using InsureTrust.API.Data;
using InsureTrust.API.Exceptions;
using InsureTrust.API.Helpers;
using InsureTrust.API.Infrastructure.Repositories;
...
builder.Services.AddAutoMapper(typeof(PremiumQuoteMappingProfile).Assembly);
builder.Services.AddFluentValidationAutoValidation();
builder.Services.AddValidatorsFromAssemblyContaining<PremiumQuoteRequestValidator>();
...
builder.Services.AddScoped<IPolicyTypeReadRepository, PolicyTypeReadRepository>();
builder.Services.AddScoped<IPremiumQuoteService, PremiumQuoteService>();
builder.Services.AddScoped<IPolicyCatalogService, PolicyCatalogService>();
