...
/// <summary> 5. Product Inventory and Sales Query 
/// </summary>
class Product 
    { 
        public int Id; 
...
///////////////////////////////////// Student Performance Analytics /////////////////////////////////////
        ...
        var belowAvg = students.Where(s => s.Marks
         < (students.Where(x=>x.Class == s.Class).Average(a=>a.Marks)));
         foreach(var s in belowAvg)
         {
            Console.WriteLine("Students below class average: " + s.Name + " from class " + s.Class + " with marks " + s.Marks);
         }
...
////////////////////////////////////Product Inventory and Sales Query//////////////////////////////////////
        ...
        //    {
        //         Console.WriteLine("Product: " + data.Name + ", Quantity Sold: " + data.Qty);
        //    }
