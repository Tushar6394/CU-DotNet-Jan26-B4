...
class Program
{
    ...
    {
        // 1. Initialize Nodes
        var ceo = new EmployeeNode("Tushar", "CEO");
        var cto = new EmployeeNode("Aman", "CTO");
        var manager = new EmployeeNode("Sahil", "Dev Manager");
        var dev1 = new EmployeeNode("Aditya", "Senior Dev");
        var dev2 = new EmployeeNode("Alok", "Junior Dev");
        var cfo = new EmployeeNode("Rahul", "CFO");
