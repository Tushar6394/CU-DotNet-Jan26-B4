...
{
    internal class DemoXMLSerialization
    {
        /*
        static void Main(string[] args)
        {
            ...
            using (StreamReader sr = new StreamReader(xmlFile))
            {
                ...
                {
                    Console.WriteLine($"LaptopId: {Laptop.LaptopId}, ModelName: {Laptop.ModelName}, Price: {Laptop.Price}");
                }
            }

            Console.WriteLine("XML Serilaization Done...");
